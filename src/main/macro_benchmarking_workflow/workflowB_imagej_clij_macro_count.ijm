...
resultFolder = "D:/benchmark/clij_out_myers-pc-21/"
computerName = "myers-pc-21";

cl_device = "[Intel(R) UHD Graphics 620]";
//cl_device = "P6000";

timeLogFile = "C:/structure/code/clij-benchmarking-public/data/benchmarking/cellcount/" + computerName + "_workflowB_time_clij.csv";
fulltimeLogFile = "C:/structure/code/clij-benchmarking-public/data/benchmarking/cellcount/" + computerName + "_workflowB_fulltime_clij.csv";
countLogFile = "C:/structure/code/clij-benchmarking-public/data/benchmarking/cellcount/" + computerName + "_workflowB_cellcount_clij.csv";
