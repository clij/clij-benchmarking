...
import fiji.stacks.Radial_Reslice;
import ij.IJ;
import ij.ImagePlus;
...
public class RadialReslice extends DefaultBenchmarkableModule {
    ...
    public void test(ClearCLBuffer[] clb2D, ClearCLBuffer[] clb3D) {
        clij.op().radialProjection(clb3D[0], clb3D[3], angleStepSize);
        //clij.show(clb3D[3], "clij");
    }
